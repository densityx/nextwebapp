                    ...
                    <div className="w-full md:w-1/2 lg:w-2/3 mx-auto">
                        ...
                        >
                            <input
                                type="email"
                                name="email"
                                className="px-4 py-3 w-full rounded-md bg-gray-100 border-0 focus:bg-white focus:ring-0 text-sm focus:outline-blue-500"
                            ...
                            <input
                                type="password"
                                name="password"
                                className="px-4 py-3 mt-4 w-full rounded-md bg-gray-100 border-0 focus:bg-white focus:ring-0 text-sm focus:outline-blue-500"
